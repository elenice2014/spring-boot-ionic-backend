...
import com.elenice.cursomc.domain.ItemPedido;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		p1.getCategorias().addAll(Arrays.asList(cat1, cat4)); // associando produto a categoria
		...
		Cliente cli2 = new Cliente(null,"Gilson", "gilson@gmail.com", "54085729004", TipoCliente.PESSOA_FISICA, pe.encode("123"));
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sfd.parse("20/10/2017 00:00"),
				null);
